...
+(void)styleTextView:(UITextView *)textView
{
    ...
    textView.layer.shadowColor = (__bridge CGColorRef)(kFontDropShadowColour);
...
+(void)initStyles {
    NSDictionary *titleTextAttributes = [NSDictionary dictionaryWithObjectsAndKeys:
                                         kFontNavigationTextColour,NSForegroundColorAttributeName,
    ...
    [[UIBarButtonItem appearanceWhenContainedIn:[UINavigationBar class], nil] setTintColor:kFontNavigationTextColour];//kNavigationButtonBackgroundColour
    ...
    NSDictionary *disabledBarButtonItemTextAttributes = [NSDictionary dictionaryWithObjectsAndKeys:
                kFontNavigationDisabledTextColour,NSForegroundColorAttributeName,
                [UIColor whiteColor], UITextAttributeTextShadowColor,
    ...
    //switched the color from White to Dark...
    barButtonItemTextAttributes = [NSDictionary dictionaryWithObjectsAndKeys:[UIColor whiteColor], NSForegroundColorAttributeName,
                                   nil];
    ...
    //TABLE VIEW
    //Make the table view background transparent for all table views globally
    //Ensure we never see Apple's default blue selection styles
